...
export default ({ store }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.amount}>{`${store.state.currency} ${
        store.state.balance
      }`}</Text>
